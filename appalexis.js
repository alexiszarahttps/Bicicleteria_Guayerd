...
function onLoadCartNumbers() {
  ...
  if (productNumbers) {
    document.querySelector(".navegacion span").textContent = productNumbers;
  }
}
...
function cartNumbers(product, action) {
  ...
  if (action) {
    ...
    document.querySelector(".navegacion span").textContent = productNumbers - 1;
    ...
    document.querySelector(".navegacion span").textContent = 1;
  }
  setItems(product);
}
...
function displayCart() {
  ...
  if (cartItems && productContainer) {
    ...
    Object.values(cartItems).map((item, index) => {
      productContainer.innerHTML += `<div class="product"><ion-icon name="close-circle"></ion-icon><img src="/cascosimg/${
        item.tag
      }.jpg"/>
